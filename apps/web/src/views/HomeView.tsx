      ...
      <section className="hero">
        <div>
          ...
          <p className="hero__lede">
            ...
            tickets, supervision et materiel. Chaque commande que vous tapez modifie reellement
            cette infrastructure, et chaque objectif est verifie sur son etat, jamais sur un clic.
          </p>
          ...
          >
            Aucun compte requis. Votre progression reste sur cet appareil tant que vous ne demandez
            pas explicitement de synchronisation.
          </p>
        </div>
        ...
        <div className="neo-card">
          ...
          {session.progress.badges.length > 0 ? (
            ...
            <p className="neo-dim" style={{ fontSize: 'var(--neo-fs-sm)', marginBottom: 0 }}>
              Les badges sont purement pedagogiques. TSSR NEO ne delivre aucune certification ni
              attestation.
            </p>
          )}
        </div>
      ...
      <section>
        ...
        <div className="card-grid">
          <article className="course-card">
            <h3 style={{ fontSize: 'var(--neo-fs-md)' }}>
              Un reseau qui se comporte comme un reseau
            </h3>
            <p className="neo-muted" style={{ fontSize: 'var(--neo-fs-sm)', margin: 0 }}>
              Commutation VLAN, ARP, routage au plus long prefixe, pare-feu, NAT, DNS et DHCP sont
              simules. Un port dans le mauvais VLAN casse vraiment la connectivite, et le diagnostic
              explique pourquoi.
            </p>
          </article>
          <article className="course-card">
            ...
            <p className="neo-muted" style={{ fontSize: 'var(--neo-fs-sm)', margin: 0 }}>
              Les commandes agissent sur l etat simule. Une commande non implementee est refusee
              explicitement, jamais remplacee par une reponse fabriquee.
            </p>
          </article>
          <article className="course-card">
            ...
            <p className="neo-muted" style={{ fontSize: 'var(--neo-fs-sm)', margin: 0 }}>
              ...
              documentation. Plusieurs solutions valides sont acceptees, et le debrief les compare.
            </p>
          </article>
          <article className="course-card">
            <h3 style={{ fontSize: 'var(--neo-fs-md)' }}>Hors ligne et sans traqueur</h3>
            <p className="neo-muted" style={{ fontSize: 'var(--neo-fs-sm)', margin: 0 }}>
              Tout fonctionne localement. Aucune publicite, aucun suivi marketing, aucune donnee
              envoyee sans votre accord explicite.
            </p>
          </article>
        </div>
      </section>
