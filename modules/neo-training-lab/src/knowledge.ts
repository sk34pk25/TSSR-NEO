...
export const trainingLabCompetencies: Competency[] = [
  {
    ...
    description: 'Comprendre le role d un VLAN, configurer un port en acces et verifier son affectation.',
    prerequisites: [],
    level: 3,
  },
  {
    ...
    description: 'Comprendre la sequence DHCP, ses limites de diffusion et interpreter une adresse d auto-configuration.',
    prerequisites: [],
    level: 3,
  },
  {
    ...
    description: 'Isoler une panne par comparaison et par elimination, en partant des couches basses.',
    prerequisites: [],
    level: 3,
  },
  {
    ...
    description: 'Renseigner une resolution exploitable : symptome, cause racine, action, verification.',
    prerequisites: [],
    level: 2,
  },
];
...
export const trainingLabKnowledge: KnowledgeEntry[] = [
  {
    ...
    summary: 'Un VLAN cree plusieurs reseaux logiques independants sur un meme equipement physique.',
    body:
  ...
  },
  {
    ...
    summary: 'Le client diffuse une demande, un serveur du meme domaine de diffusion propose un bail.',
    body:
  ...
  },
  {
    ...
    command: {
      ...
      examples: [
        { cmd: 'ipconfig /all', explanation: 'affiche l adressage complet, y compris l adresse physique et les serveurs DNS' },
  ...
  },
  {
    ...
    command: {
      os: 'both',
      syntax: 'show vlan brief | show interfaces status | interface <port> ; switchport access vlan <id>',
      examples: [
        { cmd: 'show vlan brief', explanation: 'liste les VLAN declares et les ports qui leur sont affectes' },
        { cmd: 'show interfaces status', explanation: 'affiche l etat, le VLAN et le debit de chaque port' },
